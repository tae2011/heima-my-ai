...
import com.itheima.myai.entity.vo.Result;
import com.itheima.myai.repository.ChatHistoryRepository;
import com.itheima.myai.repository.FileRepository;
import com.itheima.myai.utils.PromptUtils;
...
public class PdfController {
    ...
    public Flux<String> chat(String prompt, String chatId) {
        ...
        String prompt1 = promptUtils.getPrompt(prompt, file.getFilename());
        // 2.保存会话id
        chatHistoryRepository.save("pdf", chatId);
        // 3.请求模型
        return pdfChatClient.prompt(prompt1)
